...
def prepare_commands_list() -> None:
    ...
    commands_generator.add_command(
    ["Create Directory", "create_directory", {"directory": "<path_to_directory>"}
    ])
    commands_generator.add_command(
    ["Remove Directory", "remove_directory", {"directory": "<path_to_directory>"}
    ])
    commands_generator.add_command(
    ["Move Directory", "move_directory", {"directory": "<directory>", "destination": "<destination_path>"}
    ])
    commands_generator.add_command(
    ...
    commands_generator.add_command(
    ["Browse Website", "browse_website", {"url": "<url_to_browse>", "search": "<question about website>"}
    ])
    commands_generator.add_command(
